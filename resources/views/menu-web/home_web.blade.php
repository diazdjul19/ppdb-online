...
@section('content-web')
    ...
    <section class="hero-banner magic-ball">
        <div class="container">
            ...
            @if ($message = Session::get('not_access_not_date'))
                <div class="alert alert-danger alert-bordered pd-y-20" role="alert">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                    ...
                    <i class="icon ion-ios-close alert-icon tx-52 tx-danger mg-r-20"></i>
                    <div class="mg-t-20 mg-sm-t-0">
                        <h5 class="mg-b-2 tx-danger">MOHON MAAF PENDAFTARAN SAAT INI SADANG DI TUTUP</h5>
                        <p class="mg-b-0 tx-gray mt-2">
                            {{$message}}<br>
                            Silahkan pantau terus halaman ini.
                        </p>
                    </div>
                    </div><!-- d-flex -->
                </div><!-- alert -->
            ...
            @if ($message = Session::get('not_access_use_date'))
                <div class="alert alert-danger alert-bordered pd-y-20" role="alert">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                    ...
                    <div class="mg-t-20 mg-sm-t-0">
                        ...
                        <p class="mg-b-0 tx-gray mt-2">
                            {{$message}}<br>
                            Website ppdb.digitaltech.id akan terus kami UPDATE.<br>
                            Silahkan pantau terus halaman ini.
                        </p>
                    </div>
                    </div><!-- d-flex -->
        ...
        <div class="row align-items-center text-center text-md-left">
            <div class="col-md-7 col-lg-5 mb-5 mb-md-0">
                ...
                <a class="button button-hero mt-4" href="{{route('create-pendaftaran')}}">Daftar Sekarang</a>
            </div>
    ...
    <section class="section-margin generic-margin">
        ...
        <div class="section-intro text-center pb-90px">
            ...
            <h2 class="mt-3">Selamat Datang di Layanan PPDB Online</h2>
