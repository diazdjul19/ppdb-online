...
@section('br-mainpanel')
    ...
    <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">Management Siswa Rejected</span>
        </nav>
    </div><!-- br-pageheader -->

    {{-- br-title --}}
    <div class="br-pagetitle">
        <i class="fa fa-user-times" style="font-size:65px;color:#000;"></i>
        <div>
            <h4>Management Siswa Rejected</h4>
    ...
    <div class="br-pagebody">
        ...
        <div class="d-sm-flex align-items-center mb-4">
            ...
            <div class="mg-t-20 mg-lg-t-0">
                Action Management Siswa Rejected
            </div><!-- col-4 -->
        ...
        <form action="{{route('select-delete-rejected')}}" method="post">
            @csrf
