...
@section('br-mainpanel')
    ...
    <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">MaCont Prosedur Syarat</span>
        </nav>
    </div><!-- br-pageheader -->
                ...
                <div class="row justify-content-center">
                    <div class="col-12 grid-margin">
                            <div class="d-md-flex align-items-center mb-4">
                                ...
                                <h4 class="card-title mb-md-0">MaCont Prosedur Syarat</h4>
                            </div>              
                            <form class="form-sample" action="{{route('macont-prosedur-syarat-store')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Nama</label>
                                    <input type="text" name="nama_content" class="form-control" id="exampleInputEmail1" autocomplete="off"  readonly value="Prosedur & Syarat" required >
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputEmail1">MD5 Unik Code </label>
                                    <input type="text" name="code_unik" class="form-control" id="exampleInputEmail1" autocomplete="off"  readonly value="ea385809eefed48c3c3abb6dc680945e" required >
                                </div>
        ...
        <div class="br-pagebody">
            ...
            @if ($message = Session::get('success_create'))
                <div class="alert alert-success alert-bordered pd-y-20" role="alert">
                    ...
                    <div class="mg-t-20 mg-sm-t-0">
                        <h5 class="mg-b-2 tx-success">Success Create Data Product & Syarat</h5>
            ...
            @if ($message = Session::get('success_update'))
                <div class="alert alert-success alert-bordered pd-y-20" role="alert">
                    ...
                    <i class="icon ion-ios-checkmark alert-icon tx-52 mg-r-20 tx-success"></i>
                    <div class="mg-t-20 mg-sm-t-0">
                        <h5 class="mg-b-2 tx-success">Success Update Data Product & Syarat</h5>
                        <p class="mg-b-0 tx-gray">{{$message}}</p>
                    </div>
                    </div><!-- d-flex -->
                </div><!-- alert -->
            ...
            <div class="br-section-wrapper">
                <div class="row justify-content-center">
                    <div class="col-12 grid-margin">
                            ...
                            <form class="form-sample" action="{{route('macont-prosedur-syarat-update', $data_code->id)}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                {{method_field('put')}}
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Nama</label>
