...
@section('br-mainpanel')
    ...
    <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">MaWeb Contact Us</span>
        </nav>
    </div><!-- br-pageheader -->
    ...
    <div class="br-pagebody">
        ...
        <div class="d-sm-flex align-items-center mb-4">
            ...
            <div class="mg-t-20 mg-lg-t-0">
                Action MaWeb Contact Us
            </div><!-- col-4 -->

            <a href="{{route('maweb-contact-us-create')}}" class="btn btn-primary btn-with-icon ml-auto mb-3 mb-sm-0">
                <div class="ht-40">
                    ...
                    @foreach ($data as $d)
                        <tr>
                            ...
                            <td class="text-center pt-3">
                                @if ($d->jenis_maweb == 'maweb_contact_us')
                                    MaWeb Hasil Seleksi
                                @endif
                            </td>
                            <td class="text-center pt-3">
