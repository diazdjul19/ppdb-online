...
@section('br-mainpanel')
    ...
    <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">MaCont Daftar Ulang</span>
        </nav>
    </div><!-- br-pageheader -->
                ...
                <div class="row justify-content-center">
                    <div class="col-12 grid-margin">
                            <div class="d-md-flex align-items-center mb-4">
                                ...
                                <h4 class="card-title mb-md-0">MaCont Daftar Ulang</h4>
                            </div>              
                            <form class="form-sample" action="{{route('macont-daftar-ulang-store')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Nama</label>
                                    <input type="text" name="nama_content" class="form-control" id="exampleInputEmail1" autocomplete="off"  readonly value="Daftar Ulang" required >
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputEmail1">MD5 Unik Code </label>
                                    <input type="text" name="code_unik" class="form-control" id="exampleInputEmail1" autocomplete="off"  readonly value="86397b70d3bfde246082defe4d67288a" required >
                                </div>
            ...
            <div class="br-section-wrapper">
                <div class="row justify-content-center">
                    <div class="col-12 grid-margin">
                            ...
                            <form class="form-sample" action="{{route('macont-daftar-ulang-update', $data_code->id)}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                {{method_field('put')}}
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Nama</label>
